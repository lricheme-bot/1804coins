...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 bg-gray-100">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid md:grid-cols-2 gap-16 items-center">
        {/* Left - Hero Image */}
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-normal text-red-600">
